...
export function AreasAtuacao() {
  ...
  return (
    <Section className="flex flex-col px-10 gap-8 max-lg:px-0">
      ...
      <div className="flex self-start w-full sm:md:w-auto overflow-x-auto gap-5 sm:md:justify-between sm:md:self-auto sm:md:gap-6 sm:md:overflow-hidden sm:md:relative">
